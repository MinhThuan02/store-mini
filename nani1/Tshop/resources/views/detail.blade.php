            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="{{asset('/')}}public/uploads/product/{{ $sp->img }}" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">{{number_format($sp->price,0,'.','.')}}VND</div>
                        <p>{{$sp->description}}</p>
                        ...
                        <form action="{{ URL::to('/save-cart') }}" method="post">
                            ...
                            <button type="submit" style="border: none" class="primary-btn">ADD TO CARD</button>
                      ...
                      @endif
                        ...
                        <ul>
                            <li><b>Availability</b> <span>{{$sp->sold}}</span></li>
